...
//	//-------------------------------------------------------------	
	...
	private void processarRequisicao(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// Define onde a lista de alunos está armazenada (na sessao do usuário ou na requisicao) 
		...
		// Colocamos também a lista no request, para podermos exibir na tabela de alunos
		request.setAttribute("alunosCadastrados", listaAlunos);
		
		// E encaminhamos a requisicao para a tela que contém a tabela de alunos
